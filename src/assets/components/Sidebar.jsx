...
const Sidebar = () => {
    ...
    return (
        <>
            <div className='flex'>
                <div className="hidden md:flex flex-col  w-20 border-r border-white p-4">
                ...
                <div className='hidden  h-157 md:left-0 md:w-64 md:flex md:flex-col bg-[#000] text-gray-500  p-4 shadow-xl border-2'>
