        ...
        return (
          <div className="h-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-3 w-full">
              ...
              <div className="w-full lg:w-3/4 border-2 border-gray-700 rounded-lg mt-6">
                <Linechart />
              </div>

              <div className="w-full lg:w-1/4 bg-black text-white p-4 rounded-lg border border-gray-700 mt-6">
                ...
                <div className="border-t border-gray-700 p-4 mt-2 flex items-center text-gray-400 hover:text-white cursor-pointer">
                  <p className="text-sm text-right">View insights</p>
            ...
            <div className="border-2 border-gray-700 rounded-lg mt-6 hidden lg:block w-full">
              <Demographics />
            </div>
          </div>
        );
      ...
      <div>
        ...
        <div className="hidden lg:flex text-sm font-medium text-gray-400 border-b border-gray-700 items-center h-13">
          <div
            ...
            className={`w-32 text-center cursor-pointer flex justify-center items-center h-full ${activeTab === "overview" ? "text-white" : ""
              }`}
          >
            Overview
          </div>
